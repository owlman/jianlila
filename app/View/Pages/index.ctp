...
<div class="row">
    ...
    <div class="span4">
    	<h2>晒简历</h2>
    	<p>
    		我们将为您提供一系列投递方式，以便您根据自己的喜好投出最理想的简历!
    	</p>
    	<a class="btn btn-primary btn-xlarge" href="/Resumes/show">去看看</a>
    </div>
    <div class="span4">
    	<h2>搜简历</h2>
    	<p>
    		我们将为您提供海量的信息，以便您找到最中意的人才!
    	</p>
    	<a class="btn btn-primary btn-xlarge" href="/Resumes/search">去找找</a>
    </div>
</div>