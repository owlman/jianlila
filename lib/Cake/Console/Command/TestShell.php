...
class TestShell extends Shell {
	...
	public function getOptionParser() {
		...
		$parser->description ( __d ( 'cake_console', 'The CakePHP Testsuite allows you to run test cases from the command line' ) )->addArgument ( 'category', array (
	 ...
	 *        	The test file category.
	 * @param bool $throwOnMissingFile
