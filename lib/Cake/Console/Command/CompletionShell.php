...
class CompletionShell extends AppShell {
	...
	public function getOptionParser() {
		...
		$parser->description ( __d ( 'cake_console', 'Used by shells like bash to autocomplete command name, options and arguments' ) )->addSubcommand ( 'commands', array (
		...
		) )->epilog ( __d ( 'cake_console', 'This command is not intended to be called manually' ) );
