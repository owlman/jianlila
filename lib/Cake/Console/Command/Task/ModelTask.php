...
class ModelTask extends BakeTask {
	...
	public function doActsAs($model) {
		...
		if (isset ( $fields ['lft'] ) && $fields ['lft'] ['type'] === 'integer' && isset ( $fields ['rght'] ) && $fields ['rght'] ['type'] === 'integer' && isset ( $fields ['parent_id'] )) {
			$behaviors [] = 'Tree';
		}
		return $behaviors;
	}
	...
	public function getOptionParser() {
		...
		$parser->description ( __d ( 'cake_console', 'Bake models.' ) )->addArgument ( 'name', array (
