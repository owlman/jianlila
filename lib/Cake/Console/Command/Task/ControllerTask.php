...
class ControllerTask extends BakeTask {
	...
	public function getOptionParser() {
		...
		$parser->description ( __d ( 'cake_console', 'Bake a controller for a model. Using options you can bake public, admin or both.' ) )->addArgument ( 'name', array (
